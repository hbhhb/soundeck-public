...
function Frame3() {
  return <div className="absolute bg-[#27262b] h-[53px] left-0 rounded-[4px] top-[-30px] w-[127px]" />;
}

function Frame4() {
  return (
    <div className="absolute h-[45px] left-[0.46px] rounded-[4px] top-[60.83px] w-[204px]">
      <Frame3 />
    </div>
  );
}
...
export default function SoundCardMobile() {
  return (
    <div className="bg-[#1f1f20] border-[0.537px] border-solid border-zinc-800 overflow-clip relative rounded-[14px] size-full" data-name="SoundCard Mobile">
      <Container2 />
    </div>
  );
}